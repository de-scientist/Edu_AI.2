...
import { MessageSquare, ThumbsUp, Share2, Bookmark, Send, Plus, X, ChevronDown, ChevronUp } from "lucide-react";
import toast from "react-hot-toast";
import { handleLikePost } from './fixed-handleLikePost';
...
export default function CommunityPage() {
  ...
  const handleLikePostWrapper = async (postId: string) => {
    await handleLikePost(postId, setPosts, toast);
  };
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <button
                    onClick={() => handleLikePostWrapper(post.id)}
